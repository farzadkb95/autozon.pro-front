...
<div id="page" class="py-5">
    <div class="container">
        <div id="ajaxcontainer" class="mx-auto" style="max-width:600px;">
            ...
            <h2><?= $title ?></h2>
            <?= form_open('', ['data-ajaxAction' => 'account/profile/update-profile-document-api']); ?>

            <?= csrf_field() ?>
            <div class="row gx-5 gy-4 mt-2">
                <div class="col-md-12">
                    <div class="text-muted mb-1 small"><?= t("Upload Document") ?></div>
                    <p><?= t("Varification Document") ?><br><?= t("Aadhar Card / License / Rashan Card / Passport") ?></p>
                </div>
                <div class="col-md-6">
                    <div>
                        <div class="form-file form-file mb-3">
                            ...
                            <input type="hidden" name="profile_document" id="profile_photo">
